...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.normal(0, weight_scale, [np.int(input_dim[1]*input_dim[2]*num_filters/4) , hidden_dim])
    ...
    def loss(self, X, y=None):
        ...
        dout_fc1, dW3, db3 = affine_backward(dout_fc2, cache_fc2)
